...
export function verifyAccessToken(
  ...
  if (expectedBytes.byteLength !== presentedBytes.byteLength) {
    // Self-compare keeps the timing independent of the presented token's
    // length before failing (timingSafeEqual needs equal-length buffers).
