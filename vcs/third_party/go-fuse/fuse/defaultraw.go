...
func (fs *defaultRawFileSystem) Tmpfile(cancel <-chan struct{}, input *CreateIn, name string, out *CreateOut) Status {
	return ENOSYS
}
...
func (fs *defaultRawFileSystem) SyncFS(cancel <-chan struct{}, input *SyncFSIn) (code Status) {
	return ENOSYS
}
